...
exports.getAppointment=async (req,res,next) => {
    try {
        ...
        console.log((err.stack));
        return res.status(500).json({success:false,message:'Cannnot find Appointment'});
    }
}
...
exports.addAppointment=async (req,res,next) => {
    try {
        ...
        console.log(err.stack);
        return res.status(500).json({success:false,message:'Cannnot create Appointment'});
    }
}
...
exports.updateAppointment=async (req,res,next) => {
    try {
        ...
        return res.status(500).json({success:false,message:'Cannnot update Appointment'});
    }
}
...
exports.deleteAppointment=async (req,res,next) => {
    try {
        ...
        console.log(error.stack);
        return res.status(500).json({success:false,message:'Cannnot delete Appointment'});
    }
}